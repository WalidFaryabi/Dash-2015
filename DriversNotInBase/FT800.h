...
void writeString(char *s, ft_uint8_t fontsize, ft_uint8_t x, ft_uint8_t y );

extern unsigned short dli;//unsigned short //global i alle filer
/**
...
extern  unsigned short cmd_offset;//unsigned short
